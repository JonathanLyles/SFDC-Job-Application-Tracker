...
| Robust Trigger Handling         | Data                | Template Method, Helper            | Template Method, Helper                        | Trigger Framework, Task Creator                                                           | JobApplicationTrigger, JobApplicationTriggerHandler, JobApplicationTaskHelper                                                                                         | Uses **Kevin O’Hara Trigger Framework** for bulk-safe, idempotent task creation; triggers react to persisted Job_Application\_\_c records, do not orchestrate external integrations |
